...
drop function if exists create_arcade(
    ...
    new_path_config,
    new_path_program);
drop function if exists publish_report(configuration_name, new_message, new_severity);
drop function if exists latest_reports(configuration_name, reports_amount);
